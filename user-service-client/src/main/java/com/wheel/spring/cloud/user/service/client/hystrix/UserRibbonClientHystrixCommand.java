package com.wheel.spring.cloud.user.service.client.hystrix;
...
public class UserRibbonClientHystrixCommand extends HystrixCommand<Collection> {
    ...
    protected Collection run() throws Exception {
        Collection collection = restTemplate.getForObject("http://" + providerServiceName + "/user/list", Collection.class);
        return collection;
    }
